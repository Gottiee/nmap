...
bool scan_ack( t_scan_port *port, t_host host, const int16_t th_id );
bool scan_fin( t_scan_port *port, t_host host, const int16_t th_id );
bool scan_null( t_scan_port *port, t_host host, const int16_t th_id );
bool scan_syn( t_scan_port *port, t_host host, const int16_t th_id );
bool scan_xmas( t_scan_port *port, t_host host, const int16_t th_id );
