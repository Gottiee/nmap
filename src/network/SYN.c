...
// void	init_ip_h( struct tcphdr *ip_hdr, uint16_t *dst_port )
// {
// 	ip_hdr->ihl = sizeof(struct tcphdr);
// 	ip_hdr->version = 4;
// 	ip_hdr->tos = 0;
// 	ip_hdr->tot_len = htons(sizeof(struct tcphdr) + sizeof(struct tcphdr));
...
// {
// 	struct tcphdr	*r_ip = (struct tcphdr *)r_buf;
...
// 	if (check_packet(port_info->tcp_h, r_tcp, port_info->th_id) == 1)
// 		return (1);
// 	return (0);
// }
